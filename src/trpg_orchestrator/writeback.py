...
# TODO: memory_type / certainty / ttl writeback routing belongs in a separate
# memory semantics branch. This prompt-dispatch branch keeps legacy writeback
# persistence unchanged and only stores backend-only orchestration_forecast.
